    ...
    >
      <div className="h-full flex flex-col lg:flex-row px-4 sm:px-8 md:px-12 lg:px-20 xl:px-48">
        ...
        <form
          onSubmit={sendEmail}
          ref={form}
          className="h-1/2 lg:h-full lg:w-1/2 bg-red-50 rounded-xl text-lg sm:text-xl flex flex-col gap-4 sm:gap-6 md:gap-8 justify-center p-6 sm:p-12 md:p-16 lg:p-24"
        >
          <span>Dear Abhi,</span>
          <textarea
            rows={5}
